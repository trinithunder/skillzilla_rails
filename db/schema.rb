...
ActiveRecord::Schema[7.1].define(version: 2024_02_12_154055) do
  ...
  create_table "app_layers", charset: "utf8", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "days_streaks", charset: "utf8", force: :cascade do |t|
    t.integer "count"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "hubs", charset: "utf8", force: :cascade do |t|
    t.string "title"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "learning_styles", charset: "utf8", force: :cascade do |t|
    t.string "title"
    t.text "message"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "life_stages", charset: "utf8", force: :cascade do |t|
    t.string "title"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "privacy_policies", charset: "utf8", force: :cascade do |t|
    t.string "title"
    t.text "message"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "theme_colors", charset: "utf8", force: :cascade do |t|
    t.string "title"
    t.string "hexCode"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "topic_comments", charset: "utf8", force: :cascade do |t|
    t.text "body"
